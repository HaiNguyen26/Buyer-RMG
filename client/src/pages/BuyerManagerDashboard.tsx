...
const BuyerManagerDashboard = () => {
  ...
  const menuGroups = [
    {
      title: 'Tổng quan',
      items: [
        { icon: LayoutDashboard, label: 'Procurement Overview', path: '/dashboard/buyer-manager' },
      ],
    },
    {
      title: 'Quản lý',
      items: [
        { icon: Users, label: 'Buyer Team Management', path: '/dashboard/buyer-manager/team-management' },
        { icon: ClipboardCheck, label: 'PR Monitoring', path: '/dashboard/buyer-manager/pr-monitoring' },
        { icon: AlertTriangle, label: 'Exception & Risk', path: '/dashboard/buyer-manager/exceptions' },
        { icon: UserCog, label: 'User & Role Management', path: '/dashboard/buyer-manager/user-management' },
      ],
    },
    {
      title: 'Phân tích',
      items: [
        { icon: BarChart3, label: 'Reports & Analytics', path: '/dashboard/buyer-manager/reports' },
      ],
    },
    {
      title: 'Hệ thống',
      items: [
        { icon: Settings, label: 'System Config', path: '/dashboard/buyer-manager/system-config' },
      ],
    },
  ];
  ...
  const getPageSubtitle = () => {
    if (location.pathname === '/dashboard/buyer-manager') {
      ...
      return 'Theo dõi PR toàn hệ thống - Read Only';
    } else if (location.pathname.includes('/exceptions')) {
  ...
  return (
    <div className="h-screen flex flex-col bg-[#F1F5F9] overflow-hidden">
      ...
      style={{ height: '100vh' }}>
        ...
        <main ref={mainContentRef} className="flex-1 overflow-hidden bg-slate-50">
